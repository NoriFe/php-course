...
$students = [
  ['name' => 'Alice', 'grades' => [90, 85, 95, 100]],
  ['name' => 'Bob', 'grades' => [70, 75, 80, 85]],
  ['name' => 'Charlie', 'grades' => [60, 65, 70, 75]],
  ['name' => 'David', 'grades' => [80, 85, 90, 95]],
];

foreach ($students as $student) {
  $average = array_sum($student['grades']) / count($student['grades']);
  echo "{$student['name']}'s average grade is $average<br>";
}
