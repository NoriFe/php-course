...
array_push($reverseArray, 'purple', 'orange');
$reverseArray[1] = 'pink';
...
$jobListings = [
  [
    ...
    'company' => ' some company', 'contact_email' => 'some@test.co.uk',
    'contact_number' => '01378-093249', 
...
array_push($jobListings, [
  ...
  'company' => ' some company', 'contact_email' => 'some@test.co.uk', 
  'contact_number' => '01378-093249', 
  'skills' => ['javascript', 'ruby on rails', 'php', 'mysql']
],);
